!function (t, e) {
    ...
    function ot() {
        return "undefined" != typeof global && "[object global]" === {}.toString.call(global)
    }
    ...
    var ct, st = function (t, e) {
        ...
        ft = function (t) {
            ...
            if (ot()) v("SweetAlert2 requires document to initialize"); else {
                ...
                var i, r, a, c, s, u, l, d, p, f, m, g,
                    h = "string" == typeof (i = t.target) ? document.querySelector(i) : i;
                h.appendChild(o), r = t, (a = W()).setAttribute("role", r.toast ? "alert" : "dialog"), a.setAttribute("aria-live", r.toast ? "polite" : "assertive"), r.toast || a.setAttribute("aria-modal", "true"), c = h, "rtl" === window.getComputedStyle(c).direction && st(z(), _.rtl), s = k(), u = lt(s, _.input), l = lt(s, _.file), d = s.querySelector(".".concat(_.range, " input")), p = s.querySelector(".".concat(_.range, " output")), f = lt(s, _.select), m = s.querySelector(".".concat(_.checkbox, " input")), g = lt(s, _.textarea), u.oninput = it, l.onchange = it, f.onchange = it, m.onchange = it, g.oninput = it, d.oninput = function (t) {
    ...
    Bt.text = Bt.email = Bt.password = Bt.number = Bt.tel = Bt.url = function (t, e) {
        return "string" == typeof e.inputValue || "number" == typeof e.inputValue ? t.value = e.inputValue : h(e.inputValue) || R('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(r(e.inputValue), '"')), yt(t, e), t.type = e.input, t
    ...
    function Et(t, s) {
        ...
        X(u), u.innerHTML = "";
        var l = parseInt(void 0 === s.currentProgressStep ? Tt() : s.currentProgressStep);
    ...
    function Lt(t, e) {
        var n, o, i, r, a = E();
        q(a, e, "header"), Et(0, e), function (t, e) {
    ...
    function Ot(t, e) {
        var n, o, i, r;
        n = e, o = W(), J(o, "width", n.width), J(o, "padding", n.padding), n.background && (o.style.background = n.background), Rt(o, n), bt(0, e), Lt(t, e), St(t, e), at(0, e), i = e, r = L(), tt(r, i.footer), i.footer && rt(i.footer, r), q(r, i, "footer"), "function" == typeof e.onRender && e.onRender(W())
    }
    ...
    var re = function (t, e, n, o) {
        Wt.swalCloseEventFinishedCallback = oe.bind(null, t, n, K(), o), e.addEventListener(ht, function (t) {
    ...
    function pe(t) {
        var e = z(), n = W();
        "function" == typeof t.onBeforeOpen && t.onBeforeOpen(n), xe(e, n, t), Ce(e, n), j() && ke(e, t.scrollbarPadding), K() || Wt.previousActiveElement || (Wt.previousActiveElement = document.activeElement), "function" == typeof t.onOpen && setTimeout(function () {
            return t.onOpen(n)
    ...
    function me(t, e) {
        "select" === e.input || "radio" === e.input ? Se(t, e) : -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(e.input) && h(e.inputValue) && Te(t, e)
    }
    ...
    var Ce = function (t, e) {
            ...
            !function () {
                if ((/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream || "MacIntel" === navigator.platform && 1 < navigator.maxTouchPoints) && !I(document.body, _.iosfix)) {
            ...
            var i = k();
            h(n.inputOptions) ? (Dt(), n.inputOptions.then(function (t) {
                e.hideLoading(), o(t)
        ...
        Ie = function (t, e, n) {
            ...
            o.stopKeydownPropagation && e.stopPropagation(), "Enter" === e.key ? qe(t, e, o) : "Tab" === e.key ? Ve(e, o) : -1 !== He.indexOf(e.key) ? Re() : -1 !== je.indexOf(e.key) && De(e, o, n)
        }, qe = function (t, e, n) {
    ...
    var Ze, Qe = function (t) {
        ...
        hideLoading: Jt, disableLoading: Jt, getInput: function (t) {
            ...
            !function (t) {
                for (var e in t) Ft(i = e) || R('Unknown parameter "'.concat(i, '"')), t.toast && (o = e, -1 !== Qt.indexOf(o) && R('The parameter "'.concat(o, '" is incompatible with toasts'))), zt(n = e) && g(n, zt(n));
                var n, o, i
            ...
            if (!t || I(t, n.hideClass.popup)) return R("You're trying to update the closed or closing popup, that won't work. Use the update() method in preConfirm parameter or show a new popup.");
            var o = {};
            Object.keys(e).forEach(function (t) {
    ...
    }), Je.DismissReason = U, Je.version = "9.10.5";
    var Xe = Je;
